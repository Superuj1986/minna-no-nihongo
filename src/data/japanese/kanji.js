export const LESSONS = [
  ...
  { id:12, name:"第１２課：Địa điểm (1)", color:"#2980b9", kanji:[
    ...
    { char:"入",viet:"NHẬP",meaning:"Vào / Nhập",on:["にゅう"],kun:["はい・い"],vocab:[{w:"入院する",r:"にゅういんします",m:"nhập viện"},{w:"入ります",r:"はいります",m:"vào"},{w:"入れます",r:"いれます",m:"cho vào"}]},
  ...
  { id:24, name:"第２４課：Địa điểm (2)", color:"#1a5276", kanji:[
    ...
    { char:"院",viet:"VIỆN",meaning:"Viện / Cơ sở",on:["いん"],kun:[],vocab:[{w:"入院する",r:"にゅういんします",m:"nhập viện"},{w:"病院",r:"びょういん",m:"bệnh viện"}]},
